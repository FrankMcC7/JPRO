...
input_csv_path = r"C:\path\to\your\input.csv" output_excel_path = r"C:\path\to\your\output.xlsx"
...
pivot_df = ( df.pivot_table( index='RFAD_Fund_CoperID', columns='IRR_Scorecard_factor', values='IRR_Scorecard_factor_value', aggfunc='first' ) .reset_index() )
